...
*(Frontend 8080 · Adminer 8081 · Postgres 5432 · Redis internal · notification-worker
3110, probes only — it consumes the notification queue and serves no API.)* In compose you can
